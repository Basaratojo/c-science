...
public class Rock {
    //this methode compare when human has choose the spock
...
//this methode compare when human has choose the lizard
...
//this methode compare when human has choose the rock
...
//this methode compare when human has choose the paper
...
//this methode compare when human has choose the Scissors
...
// we compare O w/ computer, i don't need the condition because this is the last test.
    ...
    public static void main(String[] args) {
        ...
        //we want to confert to uppercase the human input
